...
C_NATIVE(_m95_init){
    ...
    *res = MAKE_NONE();
    ...
    m95_api.accept = m95_gzsock_accept;
    m95_api.listen = m95_gzsock_listen;
    m95_api.select = m95_gzsock_select;
    m95_api.fcntl = m95_gzsock_fcntl;
    m95_api.ioctl = m95_gzsock_ioctl;
    m95_api.getaddrinfo = m95_gzsock_getaddrinfo;
    m95_api.freeaddrinfo = m95_gzsock_freeaddrinfo;
    m95_api.inet_addr = m95_gzsock_inet_addr;
    m95_api.inet_ntoa = m95_gzsock_inet_ntoa;
