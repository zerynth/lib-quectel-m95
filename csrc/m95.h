...
#if !defined(M95_MAX_SOCKS)
#define MAX_SOCKS 4
#else
#define MAX_SOCKS M95_MAX_SOCKS
#endif
#include "zerynth_sockets.h"


//Enable/Disable debug printf
#define QUECTEL_M95_DEBUG 0
#define DEBUG_CHANNEL 0

#if QUECTEL_M95_DEBUG
...
static const GSCmd gs_commands[] = {
    ...
    DEF_CMD("+CGACT", GS_RES_OK, GS_CMD_NORMAL, GS_CMD_CGACT),
    ...
    DEF_CMD("+CGPADDR", GS_RES_OK, GS_CMD_NORMAL, GS_CMD_CGPADDR),
    ...
    DEF_CMD("+CPAS", GS_RES_OK, GS_CMD_NORMAL, GS_CMD_CPAS),
    ...
    DEF_CMD("+QCCID", GS_RES_STR_OK, GS_CMD_NORMAL, GS_CMD_QCCID),
    ...
    DEF_CMD("+QICLOSE", GS_RES_STR, GS_CMD_NORMAL, GS_CMD_QICLOSE),
    DEF_CMD("+QICSGP", GS_RES_OK, GS_CMD_NORMAL, GS_CMD_QICSGP),
    DEF_CMD("+QIDEACT", GS_RES_STR, GS_CMD_NORMAL, GS_CMD_QIDEACT),
    DEF_CMD("+QIDNSCFG", GS_RES_STR_OK, GS_CMD_NORMAL, GS_CMD_QIDNSCFG),
    DEF_CMD("+QIDNSGIP", GS_RES_OK_STR, GS_CMD_NORMAL, GS_CMD_QIDNSGIP),
    DEF_CMD("+QILOCIP", GS_RES_STR, GS_CMD_NORMAL, GS_CMD_QILOCIP),
    DEF_CMD("+QIMUX", GS_RES_OK, GS_CMD_NORMAL, GS_CMD_QIMUX),
    DEF_CMD("+QINDI", GS_RES_OK, GS_CMD_NORMAL, GS_CMD_QINDI),
    DEF_CMD("+QIOPEN", GS_RES_OK_STR, GS_CMD_URC, GS_CMD_QIOPEN),
    DEF_CMD("+QIRD", GS_RES_OK, GS_CMD_NORMAL, GS_CMD_QIRD),
    DEF_CMD("+QIRDI", GS_RES_OK, GS_CMD_URC, GS_CMD_QIRDI),
    DEF_CMD("+QIREGAPP", GS_RES_OK, GS_CMD_NORMAL, GS_CMD_QIREGAPP),
    DEF_CMD("+QISACK", GS_RES_OK, GS_CMD_NORMAL, GS_CMD_QISACK),
    DEF_CMD("+QISEND", GS_RES_STR, GS_CMD_NORMAL, GS_CMD_QISEND),
    DEF_CMD("+QISTATE", GS_RES_OK, GS_CMD_NORMAL, GS_CMD_QISTATE),
    DEF_CMD("+QIURC", GS_RES_OK, GS_CMD_URC, GS_CMD_QIURC),

    DEF_CMD("+QSECDEL", GS_RES_OK, GS_CMD_NORMAL, GS_CMD_QSECDEL),
    DEF_CMD("+QSECWRITE", GS_RES_OK, GS_CMD_NORMAL, GS_CMD_QSECWRITE),
...
int _gs_check_modem_ready(void);
...
int m95_gzsock_getsockopt(int sock, int level, int optname, void *optval, socklen_t *optlen);
...
int m95_gzsock_write(int sock, const void *dataptr, size_t size);
...
int m95_gzsock_read(int sock, void *mem, size_t len);
